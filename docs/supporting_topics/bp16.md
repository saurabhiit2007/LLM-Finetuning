# 🧮 BF16 (BFloat16): Mixed Precision for Stable LLM Training
...
Diagram reference:  
https://cloud.google.com/tpu/docs/bfloat16#format

---

### 4. Why BF16 Is Stable During Training
...
### 5. Loss Scaling and Why BF16 Usually Does Not Need It
...
- BF16 usually does not, because it preserves FP32’s range
...
BF16 is natively supported on:
- Google TPUs
- NVIDIA A100, H100 GPUs
- Intel CPUs with AVX-512 BF16

Older GPUs often support FP16 but not BF16.
